...
export function ConversationTabEmptyState({
  ...
  return (
    ...
    >
      <div
        className="shrink-0 text-muted [&_svg]:size-10 [&_svg]:max-h-10 [&_svg]:max-w-10 [&_svg]:shrink-0"
        aria-hidden
      >
        {icon}
      </div>
      <p className="max-w-sm text-center text-sm font-normal leading-5 text-muted">
        {children}
      </p>
