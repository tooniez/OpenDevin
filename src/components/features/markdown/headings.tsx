...
export function h5({
  ...
  ExtraProps) {
  return (
    <h5 className="text-sm font-normal text-text-tertiary mb-1.5 mt-2.5 first:mt-0">
      {children}
    </h5>
  );
}
...
export function h6({
  ...
  ExtraProps) {
  return (
    <h6 className="text-sm font-normal text-text-tertiary mb-1.5 mt-2.5 first:mt-0">
      {children}
    </h6>
  );
}
